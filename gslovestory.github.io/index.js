...
const API_KEY = "-GDE4h0URNKq_d3TdAgWCw";
/**
 ...
 */
const API_SECRET = "u99fAq9IZXeJQj9Nx6Bq5ei273zmQ3cfbxkc";
...
document.getElementById("join_meeting").addEventListener("click", (e) => {
  ...
  const signature = ZoomMtg.generateSignature({
    ...
    success: function (res) {
      ...
      const joinUrl = "/Users/frieda/Downloads/friesam.github.io/gslovestory.github.io/schedule.html?" + testTool.serialize(meetingConfig);
      console.log(joinUrl);
  ...
  const signature = ZoomMtg.generateSignature({
    ...
    success: function (res) {
      ...
      const joinUrl =
        ...
        "/Users/frieda/Downloads/friesam.github.io/gslovestory.github.io/generic.html" +
